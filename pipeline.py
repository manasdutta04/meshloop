...
from utils.llm import demo_mode

def run_pipeline(file_path: str, progress_callback=None, demo_mode_enabled: bool = False) -> dict:
    """
    ...
    with demo_mode(demo_mode_enabled):
